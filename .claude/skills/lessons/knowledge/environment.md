...
- **2026-06-13**: 例外として **`raw.githubusercontent.com` は WebFetch でアクセス可能**。
  GitHub 上の公開ファイル（Anthropic 公式スキルの SKILL.md 等）は
  raw URL に変換すれば原文が直接読める（github.com 本体ページが 403 でも raw は通る）。
