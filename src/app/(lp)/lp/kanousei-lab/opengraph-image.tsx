      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(224,116,47,0.12) 0%, rgba(224,116,47,0.04) 40%, transparent 70%)',
          }}
        />
        ...
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(224,116,47,0.55) 0%, rgba(224,116,47,0.20) 40%, transparent 70%)',
          }}
        />
