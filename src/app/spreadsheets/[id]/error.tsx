...
export default function SpreadsheetError({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => {
    console.error('[SpreadsheetEditor] Unhandled error:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        ...
        <p className="text-sm text-slate-400 mb-6">
          スプレッドシートの読み込み中にエラーが発生しました。再試行するか、ダッシュボードに戻ってください。
        </p>
